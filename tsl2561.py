...
Code ported from Python library found here
...
'''HISTORY
v0.1 converted from sim0nx tsl2561.py to use plain fcntl access to i2c bus. no Adafruit libray required!
'''


class TSL2561(object):
    '''Driver for the TSL2561 digital luminosity (light) sensors.'''
    def __init__(self, address=None, busnum=1,
                 integration_time=TSL2561_INTEGRATIONTIME_13MS,
    ...
    def disable(self):
        ...
        self.i2c.write("%c%c" % (TSL2561_COMMAND_BIT | TSL2561_REGISTER_CONTROL, TSL2561_CONTROL_POWEROFF))
